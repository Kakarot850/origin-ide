...
export default function Home() {
    ...
    return (
        <div className={styles.container}>
            <Head>
                <title>Origin IDE - Interactive Code Editor with AI Assistance</title>
                <meta name="viewport" content="width=device-width, initial-scale=1.0" />
                <link rel="shortcut icon" href="/favicon.ico" type="image/x-icon" />
                <meta
                    name="description"
                    content="Origin IDE is a modern code editor for HTML, CSS, and JavaScript with real-time preview, AI-powered code help, and easy sharing features."
                />
                ...
                <meta name="author" content="Origin IDE Team" />
                <meta property="og:title" content="Origin IDE - Interactive Code Editor with AI Assistance" />
                <meta
                ...
                <meta property="og:url" content="https://origin-ide.vercel.app" />
            ...
            <header className={styles.header}>
                <div className={styles.headerContent}>
                    <Link href="https://origin-ide.vercel.app" className={styles.logo}>
                        <FiCode size={24} />
                        <h1>Origin IDE</h1>
                    </Link>
                    ...
                    <div className={`${styles.navLinks} ${isMenuOpen ? styles.active : ""}`}>
                        ...
                        <Link href="https://github.com/origin-ide/origin-ide" target="_blank">
                            GitHub
                        </Link>
                ...
                <div className={styles.heroContent}>
                    <div className={styles.heroText}>
                        ...
                        <p className={styles.heroDescription}>
                            Origin IDE is a modern code editor for HTML, CSS, and JavaScript with real-time preview, AI-powered code help,
                            and easy sharing.
                        </p>
            ...
            <section id="about" className={styles.aboutSection}>
                <div className={styles.aboutContent}>
                    ...
                    <p>
                        Origin IDE is an open-source practice project built with Next.js, MongoDB, and Google's Gemini AI. It demonstrates
                    ...
                    <div className={styles.socialLinks}>
                        <a
                            href="https://github.com/origin-ide/origin-ide"
                            target="_blank"
            ...
            <footer className={styles.footer}>
                <div className={styles.footerContent}>
                    <Link href="https://origin-ide.vercel.app" className={styles.footerLogo}>
                        <FiCode size={20} />
                        <span>Origin IDE</span>
                    </Link>
                    <p>
                        Made with ❤️ by{" "}
                        <a href="https://github.com/origin-ide" target="_blank" rel="noopener noreferrer">
                            Origin IDE Team
                        </a>
                    </p>
                </div>
