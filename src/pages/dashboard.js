...
export default function Dashboard() {
    ...
    const handleSelectTemplate = async (projectType) => {
        const response = await axios.post("/api/projects/create", { projectType });
                        ...
                        <div className={styles.modalContent}>
                            ...
                            <div className={styles.shareLinkContainer}>
                                <input
                                    type="text"
                                    readOnly
                                    value={`${window.location.origin}/editor/${shareType === "edit" ? selectedProject.editCode : selectedProject.viewCode
                                        }`}
